...
export default class ReactGridLayout extends React.Component<Props, State> {
  ...
  processGridItem(
    ...
    return (
      <GridItem
        ...
        maxW={l.maxW}
        static={l.static}
        droppingPosition={isDroppingElem ? droppingPosition : undefined}
      >
        {child}
      </GridItem>
    );
  ...
  onDragOver = (e: DragOverEvent) => {
    ...
    if (!this.state.droppingElem) {
      this.setState({
        droppingElem: <div key={droppingItem.i} />,
        droppingPosition,
        layout: [
          ...layout,
          {
  ...
  render() {
    ...
    return (
      <div
        ...
        style={mergedStyle}
        onDrop={isDroppable && this.onDrop}
        onDragOver={isDroppable && this.onDragOver}
      >
        {React.Children.map(this.props.children, child =>
          this.processGridItem(child)
        )}
        {isDroppable &&
          this.state.droppingElem &&
          this.processGridItem(this.state.droppingElem, true)}
        {this.placeholder()}
      </div>
    );
  }
