  ...
  return (function(t) {
    ...
    function(t, e, n) {
      ...
      function x(t, e, n, r, o, a, i, s) {
        ...
        if (a && p.length)
          return (
            D("Collision prevented on " + e.i + ", reverting."),
            (e.x = u),
            (e.y = l),
            (e.moved = !1),
            t
    ...
    function(t, e, n) {
      (function(t, n) {
        ...
        (E["[object Float32Array]"] = E["[object Float64Array]"] = E[
          ...
          (E[u] = E[l] = E[j] = E[p] = E[D] = E[f] = E[d] = E[h] = E[g] = E[
            m
          ] = E[b] = E[x] = E[S] = E[_] = E["[object WeakMap]"] = !1);
        var k = "object" == typeof t && t && t.Object === Object && t,
          P = "object" == typeof self && self && self.Object === Object && self,
          T = k || P || Function("return this")(),
          M = e && !e.nodeType && e,
        ...
        ((ct && It(new ct(new ArrayBuffer(1))) != D) ||
          (pt && It(new pt()) != g) ||
    ...
    function(t, e, n) {
        ...
        return (
          ...
          (e.prototype.onDragStop = function(t, e, n, r) {
            ...
            if (f) {
              ...
              var d = (0, u.compact)(s, this.compactType(), c),
              ...
              if (d) {
                ...
                if ((y = g.length > 0)) {
                  ...
                  g.forEach(function(t) {
                    t.x > h.x && (m = Math.min(m, t.x)),
                      t.y > h.y && (v = Math.min(v, t.y));
                  }),
                    Number.isFinite(m) && (h.w = m - h.x),
                    Number.isFinite(v) && (h.h = v - h.y);
                }
              }
              y || ((h.w = e), (h.h = n));
              var b = { w: h.w, h: h.h, x: h.x, y: h.y, static: !0, i: t };
              this.props.onResize(l, c, h, b, a, i),
                this.setState({
          ...
          (e.prototype.render = function() {
            var t = this,
              ...
              a = e.style,
              i = e.isDroppable,
              u = (0, s.default)("react-grid-layout", n),
              l = r({ height: this.containerHeight() }, a);
            return o.default.createElement(
              "div",
              {
                className: u,
                style: l,
                onDrop: i && this.onDrop,
                onDragOver: i && this.onDragOver
              },
              ...
              i &&
                ...
                this.processGridItem(this.state.droppingElem, !0),
              this.placeholder()
            );
          }),
          e
      ...
      (p.displayName = "ReactGridLayout"),
        (p.propTypes = {
          ...
          droppingPositionShift: a.default.shape({
        ...
        (this.state = {
          ...
          (this.onDragOver = function(e) {
            var n = t.props,
              ...
              h = f.layerY,
              y = { x: d + u, y: h + c, e: e };
            if (t.state.droppingElem) {
              if (t.state.droppingPosition) {
                (t.state.droppingPosition.x != d ||
                  t.state.droppingPosition.y != h) &&
                  t.setState({ droppingPosition: y });
              }
            } else
              t.setState({
                droppingElem: o.default.createElement("div", { key: a.i }),
                droppingPosition: y,
                layout: [].concat(p, [
                  r({}, a, { x: 0, y: 0, static: !1, isDraggable: !0 })
                ])
              });
...
*/
	...
	*/
        ...
        var C = (function() {
            ...
            if (t in e) return "";
            for (var n = 0; n < D.length; n++) if (z(t, D[n]) in e) return D[n];
            return "";
          })(),
          E = function(t, e) {
            if (!(t instanceof e))
                ...
                value: function() {
                  ...
                  var p = this.props,
                    ...
                    g = x(
                      y.props.className || "",
                      f,
                      (P((t = {}), d, this.state.dragging),
                      P(t, h, this.state.dragged),
                      t)
                    );
    ...
    function(t, e, n) {
      ...
      var d = (function(t) {
        ...
        return (
          ...
          (e.prototype.componentWillReceiveProps = function(t) {
            var e = t.droppingPosition,
              n = this.state.dragging;
            if (e && this.props.droppingPosition)
              if (
                (this.currentNode ||
                ...
                if (
                  (n && e.x !== this.props.droppingPosition.x) ||
                  e.y !== this.props.droppingPosition.y
                ) {
                  var r = e.x - n.left,
                    o = e.y - n.top;
                  this.onDragHandler("onDrag")(e.e, {
                ...
                this.onDragHandler("onDragStart")(e.e, {
                  node: this.currentNode,
                  deltaX: e.x,
                  deltaY: e.y
                });
